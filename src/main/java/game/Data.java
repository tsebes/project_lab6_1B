...
public class Data {
    ...
    static final String[] charactersArray = {
            "Knight,Blade storm;Water Blade;Air Blade;Fire Blade;Earth Blade;Healing aura,30;-10;0;0;0;0;-10;-10,5,5,6,4,20,3,1,2,2,5,PHYSICAL",
    ...
    static final String[] skillsArray = {
            ...
            "Fire storm,true,true,FIRE,1.4,,,35.0,Uses fire magic burn all enemies",
            ...
            "Death Parade,true,true,DARK,2.8,,,70.0,Uses powerful dark magic on all enemies",
            ...
            "Death Calling,false,true,DARK,2.8,,,40.0,Uses powerful dark magic on single enemy",
            ...
            "Healing aura,true,false,ENERGY,2.0,,,20.0,Emits aura that heals all allies",
